...
const images = document.querySelector(".imageurl");
...
//em algumas questoes e preciso utilizar imagens
//dai, esse funcao sera chamada para displaying the image on screen
//sempre que necessaria.
//basta colocar dentro do parametro a url da image and therefore it's gonna be displayed
...
function loadQuestion() {
  ...
  //code q vai ser usado quabdo houver uma imagem para mostrar
  //images.innerHTML = displayImage(item.imageurl, 100, 100);
